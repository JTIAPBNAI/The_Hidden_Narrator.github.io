...
## การติดตั้งเพื่อเริ่มต้นใช้งาน
 - ให้ทำการ download หรือ copy ไฟล์ ini_project.sh ไปยังโฟล์เดอร์โปรเจคหนังสือที่จะเขียน - [Link](https://The_Hidden_Narrator.github.io/blob/main/init_project.sh)
